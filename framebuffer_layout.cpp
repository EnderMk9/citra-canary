...
FramebufferLayout SideFrameLayout(u32 width, u32 height, bool swapped, bool upright) {
    ...
    FramebufferLayout res{width, height, true, not upright, {}, {}, true};
                Common::Rectangle<u32> top1_screen{
                    0, 0,
                    2240, 1334};
                Common::Rectangle<u32> bot1_screen{
                    1707, 1000,
                    2240, 1400};
                Common::Rectangle<u32> top2_screen{
                    0, 0,
                    2240, 1334};
                Common::Rectangle<u32> bot2_screen{
                    1880, 1130,
                    2240, 1400};
    if (swapped) {

                res.top_screen = top1_screen;
                res.bottom_screen = bot1_screen;
        } else {

                res.top_screen = top2_screen;
                res.bottom_screen = bot2_screen;
        }
    // res.top_screen = top_screen;
    // res.bottom_screen = bot_screen;
    return res;
